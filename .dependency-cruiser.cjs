  ...
  forbidden: [
    ...
    // dependencies that are _not_ declared as explicitly type-only
    {
      ...
      to: {
        circular: true,
        viaOnly: {
          // 'type-only - _explicitly_ declared as type only import
          dependencyTypesNot: ['type-only'],
          // if you use `preCompilationOnly: 'specify'` this will
          // also work, and exclude _everything_ that isn't relevant
          // at runtime
...
// generated: dependency-cruiser@16.3.10 on 2024-08-07T09:18:30.910Z
